...
class PatternBall(Pattern):
    def __init__(self, soul, board, bullets, center, interval = 50, acc = 0.1):
    ...
    def update(self):
        ...
        bullet = BulletBallFall(self.board.x + xoff, (self.board.y + self.board.size/2)+100, 0, self.board, 1, vy, vx)
